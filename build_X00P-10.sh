...
git clone -b android-10 https://github.com/aosp-stuff/platform_vendor_qcom_opensource_interfaces vendor/qcom/opensource/interfaces
git clone -b lineage-17.1 https://github.com/LineageOS/android_vendor_codeaurora_telephony vendor/codeaurora/telephony
git clone -b android-10 https://github.com/aosp-stuff/platform_vendor_qcom_opensource_dataservices vendor/qcom/opensource/dataservices
...
git clone -b android-10 https://github.com/aosp-stuff/platform_vendor_qcom_opensource_power vendor/qcom/opensource/power

git clone -b android-10 https://github.com/aosp-stuff/device_qcom_sepolicy-legacy-um device/qcom/sepolicy-legacy-um
